package com.dinogroup.screen.bill;
...
public class BillPresenter extends BaseViewPresenter<BillView>{

    private static final Logger LOG = Logger.getLogger(BillPresenter.class);
    ...
    @Inject
    BillPresenter(Flow flow, ActionBarOwner actionBarOwner) {
        this.flow = flow;
        this.actionBarOwner = actionBarOwner;
    }

    @Override
    public void dropView(BillView view) {
        super.dropView(view);
